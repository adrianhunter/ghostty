...
pub export fn default() void {
    mainWasm() catch |err| {
        std.debug.print("mainWasm failed with error: {}\n", .{err});
    };
}
pub fn mainWasm() !void {
    std.debug.print("Starting Ghostty with sokol-zig + Dear Imgui.. {}.\n", .{gl});
    std.debug.print("Starting Ghostty with sokol-zig + Dear Imgui.. {}.\n", .{ziglyph});
